...
func initSettings(db *gorm.DB) ([]models.Setting, error) {
	...
	if data.RowsAffected == 0 {
		...
		settings = []models.Setting{
			...
			{Key: models.UploadFileBytes, IsText: false, NumberValue: /* 500 MB */ 524288000, Min: 0, Max: /* 500 MB */ 524288000, Label: json.RawMessage(`{"en-US":"Max upload file bytes","zh-CN":"最大上传文件字节数"}`)},
