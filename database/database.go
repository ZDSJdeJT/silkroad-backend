...
func initSettings(db *gorm.DB) ([]models.Setting, error) {
	...
	if data.RowsAffected == 0 {
		...
		settings = []models.Setting{
			...
			{Key: models.UploadFileBytes, IsText: false, NumberValue: /* 1 GB */ 1073741824, Min: 1, Max: /* 1 GB */ 1073741824, Label: json.RawMessage(`{"en-US":"Max upload file bytes","zh-CN":"最大上传文件字节数"}`)},
